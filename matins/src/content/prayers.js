...
//
// TEXT IS LINEATED. A prayer is meant to be prayed off the screen, not read as
// a paragraph, so every text is broken at its natural phrases — one breath per
// line — and a blank line separates stanzas or versicle groups. The words and
// punctuation are the received ones and must not be altered; only the line
// breaks are ours. Both renderers preserve them (see render/prayer.js).
...
Amen.`,
  },
  {
    ...
    text: `Grant me, O Lord my God,
a mind to know thee,
a heart to seek thee,
wisdom to find thee,
conduct pleasing to thee,
faithful perseverance in waiting for thee,
and a hope of finally embracing thee.
Give me a right way of beginning,
a right way of going on,
and a right way of finishing.
Amen.`,
  },
];
