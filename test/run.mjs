...
const UNIT = [
  ...
  'aicost', 'expand', 'autoai', 'selftest', 'voicepairs', 'kept', 'use', 'calls', 'reachout', 'adsource', 'adsexport', 'quotereply', 'askme', 'photo', 'rain', 'name', 'openings', 'ready', 'opener', 'preview', 'voice', 'say', 'react', 'waitnudge', 'referral', 'prepost',
].map((n) => `${n}.test.js`);
...
const UI = [
  ...
  'expand.ui', 'winddown.ui', 'homeloop.ui', 'rain.ui', 'sendnow.ui', 'qol.ui', 'qol2.ui', 'name.ui', 'five.ui', 'ready.ui', 'opener.ui', 'preview.ui', 'say.ui', 'aikey.ui', 'react.ui', 'promise.ui', 'referral.ui', 'links.ui',
].map((n) => `${n}.test.js`);
