...
const UNIT = [
  ...
  'aicost', 'voicepairs', 'use', 'calls', 'reachout', 'adsource', 'quotereply', 'askme', 'photo', 'rain', 'name', 'openings', 'ready',
].map((n) => `${n}.test.js`);
...
const UI = [
  ...
  'winddown.ui', 'homeloop.ui', 'rain.ui', 'sendnow.ui', 'qol.ui', 'qol2.ui', 'name.ui', 'five.ui', 'ready.ui',
].map((n) => `${n}.test.js`);
