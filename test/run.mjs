...
const UNIT = [
  ...
  'aicost', 'expand', 'autoai', 'selftest', 'voicepairs', 'kept', 'use', 'calls', 'reachout', 'adsource', 'adsexport', 'quotereply', 'askme', 'photo', 'rain', 'name', 'openings', 'ready', 'opener', 'preview', 'voice', 'say', 'react', 'waitnudge', 'referral',
].map((n) => `${n}.test.js`);
