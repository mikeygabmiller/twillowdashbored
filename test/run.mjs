...
const UNIT = [
  ...
  'aicost', 'voicepairs', 'kept', 'use', 'calls', 'reachout', 'adsource', 'adsexport', 'quotereply', 'askme', 'photo', 'rain', 'name', 'openings', 'ready', 'opener', 'preview', 'voice', 'say',
].map((n) => `${n}.test.js`);
...
const UI = [
  ...
  'winddown.ui', 'homeloop.ui', 'rain.ui', 'sendnow.ui', 'qol.ui', 'qol2.ui', 'name.ui', 'five.ui', 'ready.ui', 'opener.ui', 'preview.ui', 'say.ui',
].map((n) => `${n}.test.js`);
