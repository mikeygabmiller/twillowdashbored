...
const UI = [
  ...
  'expand.ui', 'winddown.ui', 'homeloop.ui', 'rain.ui', 'sendnow.ui', 'qol.ui', 'qol2.ui', 'name.ui', 'five.ui', 'ready.ui', 'opener.ui', 'preview.ui', 'say.ui', 'aikey.ui', 'react.ui', 'promise.ui', 'referral.ui', 'links.ui', 'helper.ui', 'afterpage.ui', 'pageeditor.ui',
].map((n) => `${n}.test.js`);
